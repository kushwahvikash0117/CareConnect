...
export const getMyAlerts = () =>
  API.get("/emergency/my-alerts");

export const resolveAlert = (id) =>
  API.patch(`/emergency/${id}/resolve`);
...
export const getFamilyAlerts = () =>
  API.get("/family/alerts");

export const getSeniorLocation = (seniorId) =>
  API.get(`/family/location/${seniorId}`);
...
export const analyzeWellness = (data) =>
  API.post("/wellness/analyze", data);
